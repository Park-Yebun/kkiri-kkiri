    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://kkirikkiri.shop/api/learn/${userInfo.id}/${storyId}`,
          {
            method: "GET",
            headers: {
          ...
          {studyData.contents && studyData.contents.length > pageNumber && (
            <Page>
              <Header>
                ...
                <Voice>
                  <MaleVoice
                    onClick={() => turnOnVoice(studyData.contents[pageNumber].maleVoiceUrl)}
                    src={MaleImg}
                  />
                  {selectedVoice === studyData.contents[pageNumber].maleVoiceUrl && (
                    <audio src={studyData.contents[pageNumber].maleVoiceUrl} autoPlay />
                  )}
                  <FemaleVoice
                    onClick={() => turnOnVoice(studyData.contents[pageNumber].femaleVoiceUrl)}
                    src={FemaleImg}
                  />
                  {selectedVoice === studyData.contents[pageNumber].femaleVoiceUrl && (
                    <audio src={studyData.contents[pageNumber].femaleVoiceUrl} autoPlay />
                  )}
                </Voice>
              </Header>
              <BookImage
